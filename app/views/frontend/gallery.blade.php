...
<div class="container">
    		...
    		<?php foreach($_paintingsold as $artworks): ?>
				...
				<div class="col_1_of_4 span_1_of_4 col-md-3" style="margin: 5px;">
						<div class="view effect">
					        <a href="/frame<?php echo $artworks->paint_id; ?>"><img src="/public/assets/gallery/<?php echo $artworks->paint_imgsrc; ?>" class="img-responsive" alt="" style="width: 100px; height: 100px;"></a>
					     </div>
							<div class="cart">
