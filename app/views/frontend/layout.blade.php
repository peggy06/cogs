...
{{HTML::style('public/assets/frontend/css/bootstrap.css')}}
{{HTML::style('public/assets/backend/css/bootstrap.min.css')}}
{{HTML::style('public/assets/frontend/css/style.css')}}
...
{{HTML::script('public/assets/backend/js/jquery.min.js')}}
...
<div class="header-bottom">
	<div class="container">
		<div class="logo">
			<a href="/"><img src="/public/assets/frontend/images/logo.png" class="img-responsive" alt="" width="300px" height="30px"></a>
		</div>
		<div class="clearfix"> </div>
	</div>
</div>
