	...
	<div class="container">
		<div class="col-md-4 soccer">
			<div class="view effect">
				<a href="/paintingGallery"><img src="public/assets/gallery/l2.jpg" class="img-responsive" alt=""></a>
			</div>
			<h4><?php echo $setIndex->prdct1_category; ?></h4>
		</div>
		<div class="col-md-4 soccer">
			<div class="view effect">
				<a href="/paintingGallery"><img src="/public/assets/gallery/b2.jpg" class="img-responsive" alt=""></a>
			</div>
			<h4><?php echo $setIndex->prdct2_category; ?></h4>
		</div>
		<div class="col-md-4 soccer">
			<div class="view effect">
				<a href="/paintingGallery"><img src="/public/assets/gallery/p9.jpg"  class="img-responsive" alt=""></a>
			</div>
...
<div class="become">
	<div class="container">
		...
		<div class="col-md-7 become-2">
			<img src="/public/assets/frontend/images/map.png" class="img-responsive" alt="">
		</div>
			<div class="clearfix"> </div>
	</div>
</div>
