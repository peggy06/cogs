				...
				<div class="col_1_of_4 span_1_of_4 col-md-3" style="margin: 5px;">
							<div class="cart">
								...
								<div class="view effect">
					        		<a href="/frame<?php echo $artworks->paint_id; ?>"><img src="/public/assets/gallery/<?php echo $artworks->paint_imgsrc; ?>" class="img-responsive" alt="" style="width: 260px; height: 182px;"></a>
					     		</div>
								...
								<div class="view effect">
					        		<a href="/viewer<?php echo $artworks->paint_id; ?>"><img src="public/assets/gallery/<?php echo $artworks->paint_imgsrc; ?>" class="img-responsive" alt="" style="width: 260px; height: 182px;"></a>
					     		</div>
								<p class="title"><a href="/frame<?php echo $artworks->paint_id; ?>"><?php echo $artworks->paint_name; ?></a></p>
