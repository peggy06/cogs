	...
	<div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" style="height:600px;">
                                <div class="x_title">
                                    <h2>Order List | <small> Shows the  record of orders </small></h2>
                                    <div class="clearfix"></div>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php foreach($order as $userorder): ?>
                                            <tr>
                                                <td scope="row"><?php echo $userorder->order_id; ?></td>
                                                <td><?php echo $userorder->order_date; ?></td>
                                                <td><?php echo $userorder->status; ?></td>
                                                <td><a href="/viewOrder<?php echo $userorder->order_id; ?>">View</a> | <a  href="/confirmdispose<?php echo $userorder->order_id; ?>">Dispose</a></td>
                                            </tr>
                                         <?php endforeach;?>
                                        </tbody>
                                    </table><br>
