						...
						<table class="table table-striped responsive-utilities jambo_table bulk_action">
                            ...
                            <?php foreach($_painting as $artworks): ?><!--start artworks iteration for class view-->
	                            ...
	                            <tr class="even pointer">
	                            	...
	                            	<td class=" ">
	                            		<img src="/public/assets/gallery/<?php echo $artworks->paint_imgsrc; ?>" width="100px" height="100px" class="responsive"/>
	                            	</td>
	                            	<td class=" ">
		                            ...
		                            <td class=" last">
		                            	<a href="/viewpainting<?php echo $artworks->paint_id; ?>">View</a> | 
						...
						<form id="demo-form2" action="/painting<?php echo ($class=="new")?"save":(($class=="edit")?"update".$painting_id:""); ?>" method="post" class="form-horizontal form-label-left input_mask"" enctype="multipart/form-data">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<?php elseif($class=="edit"): ?>
										<img src="/public/assets/gallery/<?php echo $painting_src; ?>" width="300px" height="300px" class="responsive">
									
									<?php elseif($class=="view2"): ?>
										<img src="/public/assets/gallery/<?php echo $painting_src; ?>" width="300px" height="300px" class="responsive">
									<?php endif; ?>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="paint-name">
						 		...
						 		<div class="col-md-6 col-sm-6 col-xs-12">
						 			<input type="text" name="paint_name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo ($class=="edit" || $class=="view2" )?$painting_name:""; ?>" <?php echo ($class=="view2")?"readonly": ""?>> 	
						 		</div>
						 	</div>
						 	<div class="form-group">
						 		...
						 		<div class="col-md-6 col-sm-6 col-xs-12">
						 			<textarea class="form-control" rows="5" name="paint_desc" required="required" <?php echo ($class=="view2")? "readonly" : "";?>><?php echo ($class=="edit"  || $class=="view2" )?$painting_desc:""; ?></textarea>
						 		</div>
						  	</div>
						  	<?php if($class!="view2"):?>
						  	<div class="form-group">
						  		...
						  		<div class="col-md-6 col-sm-6 col-xs-12">
						  			<div id="gender" class="btn-group" data-toggle="buttons">
						  				<label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
						  					<input type="radio" name="status" value="2" <?php echo ($class=="edit")?(($painting_status==2)?"checked":""):""; ?> /> &nbsp; Old &nbsp;
						  				</label>
						  				<label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
						  					<input type="radio" name="status"  value="1" <?php echo ($class=="edit")?(($painting_status==1)?"checked":""):""; ?> /> New
						  				</label>
						  			</div>
						  		</div>
						  	</div>
						  	...
						  	<?php if($class!="view2" || $class=="edit"):?>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" id="number" name="paint_price" min="1000" max="50000" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" <?php echo ($class=="view2")?"readonly": ""?>>
                                            </div>
                                           
						  	<?php else:?>
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">{{$painting_price;}}</span>
                                            </label>
