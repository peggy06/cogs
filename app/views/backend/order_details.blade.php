	...
	<div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" style="height:600px;">
                                <div class="x_title">
                                    <h2>Order Details | <small> Shows the  record of orders </small></h2>
                                    <div class="clearfix"></div>
                                ...
                                <p>Customer Details</p>
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php foreach($user as $_user): ?>
                                            <tr>
                                                <td scope="row"><?php echo $_user->id; ?></td>
                                                <td><?php echo $_user->user_fname ?> <?php echo $_user->user_mname ?> <?php echo $_user->user_lname ?></td>
                                                <td><?php echo $_user->user_mail; ?></td>
                                                <td><?php echo $_user->user_num; ?></td>
                                                <td><a href="/public/assets/gallery/<?php echo $_user->addr_imgsrc; ?>"><img src="/public/assets/gallery/<?php echo $_user->addr_imgsrc; ?>" width="100px" height="100px" class="responsive"/></a></td>
                                            </tr>
                                         <?php endforeach;?>
                                        </tbody>
                                    </table><br>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php foreach($order as $userorder): ?>
                                            <tr>
                                                <td scope="row"><?php echo $userorder->product_id; ?></td>
                                                <td><?php echo $userorder->product_name; ?></td>
                                                <td><?php echo $userorder->product_qnty; ?></td>
                                                <td><?php echo $userorder->product_price; ?></td>
                                                <?php $total = $total + $userorder->product_price;?>
                                            </tr>
                                         <?php endforeach;?>
                                        </tbody>
