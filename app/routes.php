...
Route::any('/recoVerify', 'FrontendBaseController@recoVerify');
Route::any('/email_sent', 'FrontendBaseController@message_sent');
Route::any('/Congratulation', 'FrontendBaseController@done_msg');
Route::any('/forgot{mail}', 'FrontendBaseController@forgot_password');
Route::any('/start_reset', 'FrontendBaseController@recov_panel');
Route::any('/send_recovery', 'FrontendBaseController@send_recovery');
Route::any('/updateUser', 'FrontendBaseController@user_update');
Route::any('/updateUserAddr', 'FrontendBaseController@user_updateaddr');
...
Route::get('/viewpainting{id}', 'BackendBaseController@view');
	//!-painting
	//portrait
...
Route::any('/viewOrder{id}', 'BackendBaseController@order_details');
Route::any('/confirmdispose{id}', 'BackendBaseController@confirm_dispose');
Route::any('/dispose{id}', 'BackendBaseController@order_dispose');
